...
var debanjan = User(name: "Bhavishradhan", age: 22, height: 165, weight: 50, activityLevel: 1)
print(debanjan.name)
print(debanjan.age)
print(debanjan.height)
print(debanjan.weight)
print(debanjan.activityLevel)
/*:
