 ...
 */
let heartRateConst1 : Double = 65
let heartRateConst2 : Double = 80
let heartRateConst3 : Double = 90
let averageHeartRate = (heartRateConst1 + heartRateConst2 + heartRateConst3) / 3
